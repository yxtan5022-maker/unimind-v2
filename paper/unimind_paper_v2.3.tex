...
{\normalsize\rmfamily Version 2.3 (August 29, 2026) --- hardware batch filled (6-qubit routing + E2E), Algorithm~1 corrected\par}
...
With this, the middleware's fidelity contract becomes enforceable end-to-end: measure $C(q)$ once per calibration cycle, pin layouts to top-ranked qubits, and refuse or re-route when no candidate meets the threshold. What remains is to demonstrate the contract surviving composition with the software-side reliability stack --- Section~\ref{sec:e2e}.
