...
This paper makes three contributions, all measured on a 156-qubit \texttt{ibm\_marrakesh}\footnote{Verified
against the live IBM Quantum fleet on 2026-09-01 (device\_identity.py, notes/device\_identity.md):
...
sibling device, not a successor.} device across three
...
therefore day-scale bounds, not a full-cycle spectrum. \textbf{Placement null
